...
class _HomeDrawerState extends State<HomeDrawer> {
  ...
  void tapToManage() {
    Navigator.push(
        context, MaterialPageRoute(builder: (c) => const Managefolder()));
  }
      ...
      child: SingleChildScrollView(
        child: Column(
          ...
          children: [
            ...
            //more folder
            isOpenFolder
                ? BlocBuilder<manageFolderCubit,manageFolderState>(
                            ...
                            children: [
                              for (int i = 0; i < listFolder.length; i++)
                                ItemFunction(
                                    Icons.folder_open,
                                    listFolder[i].name,
                                        () => tapToNoteOfFolder(listFolder[i]),
                                    false,
                                    configColor.rgbaToColor(listFolder[i].color)
                                )
                            ],
                          ),
                        );
  ...
  Widget ItemFunction(IconData icon, String title, Function()? onTap,
      bool isBackground, Color colorIcon) {
    return Padding(
